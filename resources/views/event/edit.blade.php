...
@enderror
        ...
        <input type="text" name="dateajout" value="{{$event->dateajout}}" id="dateajout" class="form-control"></br>
...
@enderror
        ...
        <input type="text" name="datefin" value="{{$event->datefin}}" id="datefin" class="form-control"></br>
        @error('datefin')
...
@enderror
        ...
        <input type="text" name="velo_id" value="{{$event->velo_id}}" id="velo_id" class="form-control"></br>
...
@enderror
        ...
        <input type="text" name="picture" value="{{$event->picture}}" id="picture" class="form-control"></br>
